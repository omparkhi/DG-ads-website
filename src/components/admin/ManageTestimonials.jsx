    ...
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-slate-400">Manage client reviews and feedback slider</p>
        </div>
        <button
          onClick={() => {
            resetForm();
      ...
      {loading ? (
        <div className="py-20 text-center text-slate-400">Loading testimonials...</div>
            ...
            >
              <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full overflow-hidden bg-slate-800 flex items-center justify-center shrink-0 border border-slate-700">
                    {item.avatarUrl ? (
